                ...
                <form class="col-sm-12" action="store_users.php" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10 mb-5">
                            <input type="radio" class="form-control" name="gender" value="<?=$user->gender ?>" <?php $user->gender ==="" || $user->gender==="male" ? print "checked" :print""; ?>>男性
                            <input type="radio" class="form-control" name="gender" value="<?=$user->gender ?>" <?php $user->gender ==="" || $user->gender==="female"?print "checked" :print ""; ?>>女性
                        </div>
                    </div>
